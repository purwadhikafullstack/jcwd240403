                        ...
                        </Row>
                        {
                            showDecline ?
                                ...
                                order?.id == cancelConfirm ?
                                    <>
                                        <div className='gap-4'>
                                            <Button label={"Yes, Cancel This Order"} className="w-fit bg-red-600 mt-2 hover:bg-red-800" type='button' onClick={() => {
                                                cancelOrder()
                                                setShowCancel(false)
                                                setSendReason("")
                                            ...
                                            <Button label={"Close"} className="w-fit bg-gray-600 mt-2 hover:bg-gray-800" type='button' onClick={() => {
                                                setCancelConfirm(0)
                                                setShowCancel(false)
                                                setSendReason("")
                                            }} />
