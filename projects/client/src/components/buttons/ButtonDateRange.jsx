...
function ButtonDateRange({ selectedDays, handleDayClick, today, totalNight, className, asreport = false, price = null, specialPrice = null, dateSpecialPrice = [] }) {
  return (
    <Popover className={`relative ${className}`} >
      {({ close }) => (
        <>
          ...
          >
            <Popover.Panel className="absolute left-1/2 z-10 mt-3 max-w-sm -translate-x-1/2 transform px-4 sm:px-0 lg:max-w-5xl w-fit bg-slate-50">
