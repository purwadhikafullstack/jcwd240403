  ...
  return (
    <div>
      ...
      <div className="hidden lg:fixed lg:inset-y-0 lg:z-50 lg:flex lg:w-72 lg:flex-col">
        {/* Sidebar component, swap this element with another sidebar if you like */}
        <div className="flex grow flex-col gap-y-5 overflow-y-auto bg-primary/90 px-6">
          <div className="flex h-16 shrink-0 items-center mt-3">
            <ButtonWithLogo
              imageSize="w-12 h-12"
              textSize="text-lg"
          ...
          <nav className="flex flex-1 flex-col">
            <ul role="list" className="flex flex-1 flex-col gap-y-7">
              ...
              <li className="-mx-6 mt-auto">
                <a
                  href="#"
                  className="flex items-center gap-x-4 px-6 py-3 text-sm font-semibold leading-6 text-white hover:bg-primary"
                >
                  <img
      ...
      <div className="sticky top-0 z-40 flex items-center gap-x-6 bg-primary/90 px-4 py-4 shadow-sm sm:px-6 lg:hidden">
        <button
          type="button"
